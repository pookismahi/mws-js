...
(function() {
  ...
  exports.enums = {
    ...
    OrderStatuses: function() {
      return new mws.Enum(['PendingAvailability', 'Pending', 'Unshipped', 'PartiallyShipped', 'Shipped', 'InvoiceUnconfirmed', 'Canceled', 'Unfulfillable']);
    },
  ...
  exports.requests = {
    GetServiceStatus: function(props) {
      return new OrdersRequest('GetServiceStatus', props);
    },
    ListOrders: function(props) {
      return new OrdersRequest('ListOrders', props, {
        CreatedAfter: {
          name: 'CreatedAfter',
          type: 'Timestamp'
        },
    ...
    ListOrdersByNextToken: function(props) {
      return new OrdersRequest('ListOrdersByNextToken', props, {
        NextToken: {
          name: 'NextToken',
          required: true
        }
    ...
    GetOrder: function(props) {
      return new OrdersRequest('GetOrder', props, {
        AmazonOrderId: {
    ...
    ListOrderItems: function(props) {
      return new OrdersRequest('ListOrderItems', props, {
        AmazonOrderId: {
          name: 'AmazonOrderId',
          required: true
        }
    ...
    ListOrderItemsByNextToken: function(props) {
      return new OrdersRequest('ListOrderItemsByNextToken', props, {
        NextToken: {
          name: 'NextToken',
          required: true
        }
   ...
   */
  OrdersRequest = class OrdersRequest extends mws.Request {
