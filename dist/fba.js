...
(function() {
   ...
   */
  var FbaInboundRequest, FbaInventoryRequest, FbaOutboundRequest, FulfillmentRequest, mws;
  ...
  exports.requests = {
    inbound: {
      GetServiceStatus: function(props) {
        return new FbaInboundRequest('GetServiceStatus', props);
      },
      CreateInboundShipment: function(props) {
        return new FbaInboundRequest('CreateInboundShipment', props, {
          ShipmentId: {
            name: 'ShipmentId',
            required: true
          },
          ...
          InboundShipmentItems: {
            name: 'InboundShipmentItems.member',
            type: 'Complex',
            list: true,
            required: true
          }
      ...
      CreateInboundShipmentPlan: function(props) {
        return new FbaInboundRequest('CreateInboundShipmentPlan', props, {
          LabelPrepPreference: {
      ...
      ListInboundShipmentItems: function(props) {
        return new FbaInboundRequest('ListInboundShipmentItems', props, {
          ShipmentId: {
            name: 'ShipmentId',
            required: true
          },
      ...
      ListInboundShipmentItemsByNextToken: function(props) {
        return new FbaInboundRequest('ListInboundShipmentItemsByNextToken', props, {
          NextToken: {
            name: 'NextToken',
            required: true
          }
      ...
      ListInboundShipments: function(props) {
        return new FbaInboundRequest('ListInboundShipments', props, {
          ShipmentStatuses: {
      ...
      ListInboundShipmentsByNextToken: function(props) {
        return new FbaInboundRequest('ListInboundShipmentsByNextToken', props, {
          NextToken: {
            name: 'NextToken',
            required: true
          }
      ...
      UpdateInboundShipment: function(props) {
        return new FbaInboundRequest('UpdateInboundShipment', props, {
          ShipmentId: {
            name: 'ShipmentId',
            required: true
          },
    ...
    inventory: {
      GetServiceStatus: function(props) {
        return new FbaInventoryRequest('GetServiceStatus', props);
      },
      ListInventorySupply: function(props) {
        return new FbaInventoryRequest('ListInventorySupply', props, {
          SellerSkus: {
      ...
      ListInventorySupplyByNextToken: function(props) {
        return new FbaInventoryRequest('ListInventorySupplyByNextToken', props, {
          NextToken: {
            name: 'NextToken',
            required: true
          }
    ...
    outbound: {
      GetServiceStatus: function(props) {
        return new FbaOutboundRequest('GetServiceStatus', props);
      },
      CancelFulfillmentOrder: function(props) {
        return new FbaOutboundRequest('CancelFulfillmentOrder', props, {
      ...
      CreateFulfillmentOrder: function(props) {
        return new FbaOutboundRequest('CreateFulfillmentOrder', props, {
          SellerFulfillmentOrderId: {
            name: 'SellerFulfillmentOrderId',
            required: true
          },
      ...
      GetFulfillmentOrder: function(props) {
        return new FbaOutboundRequest('GetFulfillmentOrder', props, {
          SellerFulfillmentOrderId: {
            name: 'SellerFulfillmentOrderId',
            required: true
          }
      ...
      GetFulfillmentPreview: function(props) {
        return new FbaOutboundRequest('GetFulfillmentPreview', props, {
          Name: {
            name: 'Address.Name'
          },
          AddressLine1: {
      ...
      ListAllFulfillmentOrders: function(props) {
        return new FbaOutboundRequest('ListAllFulfillmentOrders', props, {
          QueryStartDateTime: {
            name: 'QueryStartDateTime',
            required: true,
            type: 'Timestamp'
      ...
      ListAllFulfillmentOrdersByNextToken: function(props) {
        return new FbaOutboundRequest('ListAllFulfillmentOrdersByNextToken', props, {
          NextToken: {
            name: 'NextToken',
            required: true
          }
   ...
   */
  FulfillmentRequest = class FulfillmentRequest extends mws.Request {
  ...
  FbaInboundRequest = class FbaInboundRequest extends FulfillmentRequest {
  ...
  FbaInventoryRequest = class FbaInventoryRequest extends FulfillmentRequest {
    constructor(action, props = {}, params = {}) {
  ...
  FbaOutboundRequest = class FbaOutboundRequest extends FulfillmentRequest {
    constructor(action, props = {}, params = {}) {
