...
###
AmazonMwsClient = (accessKeyId, secretAccessKey, merchantId, options) ->
...
###
AmazonMwsClient::call = (api, action, query, callback) ->
...
###
AmazonMwsClient::sign = (path, query) ->
...
###
AmazonMwsClient::invoke = (request, callback) ->
